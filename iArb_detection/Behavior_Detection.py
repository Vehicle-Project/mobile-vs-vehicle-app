...
# parent_path = "/mnt/c/Users/taardis/Documents/APP/"
# apkid_dir_path = "/mnt/c/Users/taardis/Documents/APKID_Result"
# # result2_path = "/mnt/c/Users/taardis/Documents/Behavior_Detection/Third_APP_Result/"
# report_dir_path = "/mnt/c/Users/taardis/Documents/Behavior_Detection/Third_APP_Result/"
# log_path = "/mnt/c/Users/taardis/Documents/log.log"

# proj_path = "/media/project/9E7EDBFF7EDBCDE1/"
...
# parent_path = r"C:\Users\taardis\Documents\APP"
# apkid_dir_path = r"C:\Users\taardis\Documents\APKID_Result"
# report_dir_path = r"C:\Users\taardis\Documents\Behavior_Detection\Third_APP_Result"
# log_path = r"C:\Users\taardis\Documents\log.log"
...
def check_apk_remain(apk_path, output_path):
    ...
    content_urls = {
        "content://call_log": ["Read Call History", "READ_CALL_LOG"],
        "content://com.android.contacts": ["Read Contact", "READ_CONTACTS"],
        "content://com.android.calendar": ["Read Schedule And To-Do List", "READ_CALENDER"],
    ...
    behaviors = [
        ["M1 Acquire Power", [""], [
            ["Lcom/xiaopeng.*.ElectriPercentEventMsg", ".*"],
        ]],
        ["M1 Acquire Front Radar", [""], [
            ["Lcom/xiaopeng.*.CameraFrontRadarEventMsg", ".*"],
        ]],
        ["M1 Acquire Rear Radar", [""], [
            ["Lcom/xiaopeng.*.CameraTailRadarEventMsg", ".*"],
        ]],
        ["M1 Acquire Steering Wheel Angle", [""], [
            ["Lcom/xiaopeng.*.CameraSteerAngleEventMsg", ".*"],
        ]],
        ["M2 Acquire Power", [""], [
            ["Lcom/byd.*", "getEnergyOilLevelValue"],
        ]],
        ["M2 Acquire Gear Oil", [""], [
            ["Lcom/byd.*", "getGearBoxOilLevelValue"],
        ]],
        ["M2 Acquire Brake Fluid", [""], [
            ["Lcom/byd.*", "getBrakeFluidOilLevelValue"],
        ]],
    ]
...
def analyze_dir(dir_name):
    ...
    for file in files:
        ...
        # pkg_name = get_package_name(full_file_path)
        # pkg_name = file[:-69]
        # pkg_name = file[:-4]
        # if pkg_name is None:
        #     print(full_file_path)
        #     input("???")
        # sha256 = get_sha256(full_file_path)
        # new_name = f"{pkg_name}_{sha256}.apk"
        # new_full_file_path = os.path.join(full_dir_path, new_name)
        ...
        # APKID查壳
        # if is_packed(full_file_path, dir_name):
        #     continue
...
def analyze_sys_apps():    
    ...
    for vendor in vendors:
            ...
            if os.path.isdir(app_path):
                ...
                for _file in _files:
                    ...
                    if _file.endswith(".apk"):
                        # true_app_path.append(os.path.join(app_path, _file))
                        true_app_path = os.path.join(app_path, _file)
            # elif os.path.isfile(app_path) and '.apk' in app:
        ...
        # if os.path.exists(priv_app_dir) == False:
        #     continue
        try:
...
# analyze_mobile_apps()
# AnalyzeAPKMultiProc("/mnt/c/Users/taardis/Documents/APP/7273/com.dofun.variety.apk",
#                     "/mnt/c/Users/taardis/Documents/Behavior_Detection/Third_APP_Result/7273/com.dofun.variety.apk.report.json")
